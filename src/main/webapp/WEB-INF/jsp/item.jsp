         ...
         <div class="form-group">
          ...
          <div class="form-group">
           <label for="price">Price</label>
              <input class="form-control" type="text" id="price" placeholder="Enter Price" name="price">
          </div>
          <div class="form-group">
           <label for="description">Description</label>
             <input class="form-control" type="textarea" id="description" placeholder="Enter Description" name="description">
          </div>
    ...
    <script src="/js/admin.js"></script>
     <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"
      ...
      <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
        <script src="/js/adminitem.js"></script>
  </body>
</html>