                            ...
                            <div class="col-lg-8">
                              <div class="p-5" id="user-cart">
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                  <h1 class="fw-bold mb-0 text-black">Placed Orders</h1>
                                </div>
                                ...
                                <div class="col-md-2 col-lg-2 col-xl-2">
                                            ...
                                            <h6 class="mb-0" style="font-weight:600">Price</h6>
                                            </div>
                                            <div class="col-md-3 col-lg-2 col-xl-2">
                                            <h6 class="mb-0"  style="font-weight:600">Quantity</h6>

                                            </div>
                                            <div class="col-md-3 col-lg-2 col-xl-2">
                                            <h6 class="mb-0" style="font-weight:600"></h6>
                                             <h6 class="mb-0"></h6>
                                            </div>
                                            </div>
                                <hr class="my-4">
